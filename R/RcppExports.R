...
C_dense_dist <- function(dist_type, XIX, xmat, YIX, ymat, pairwise = FALSE, self = FALSE) {
    .Call('simdist_C_dense_dist', PACKAGE = 'simdist', dist_type, XIX, xmat, YIX, ymat, pairwise, self)
}

C_sparse_dist <- function(dist_type, XIX, XP, XV, YIX, YP, YV, out_rows, out_cols, pairwise = FALSE, self = FALSE, xreorder = 0L, yreorder = 0L) {
    .Call('simdist_C_sparse_dist', PACKAGE = 'simdist', dist_type, XIX, XP, XV, YIX, YP, YV, out_rows, out_cols, pairwise, self, xreorder, yreorder)
}
